<template>
  <div>
    <div @mouseenter="isshow=true" @mouseleave="isshow=false" class="box">
      <span style="font-size:20px;font-weight:700;margin-right:20px">计分标准表</span>
    ...
    <el-table-column
      ...
      >
      <template slot-scope="scope">
        <span v-show="scope.row.iseditor" @click="goclick(scope.row)" style="margin-left: 10px">{{ scope.row.secendSort}}</span>
        <el-input v-model="scope.row.secendSort" v-show="!scope.row.iseditor"></el-input>
      </template>
    </el-table-column>
    <el-table-column
      prop="units"
      ...
      >
      <template slot-scope="scope">
        <span v-show="scope.row.iseditor" @click="goclick(scope.row)" style="margin-left: 10px">{{ scope.row.units}}</span>
        <el-input v-model="scope.row.units" v-show="!scope.row.iseditor"></el-input>
      </template>
    </el-table-column>
    <el-table-column
      prop="standard"
      ...
      >
      <template slot-scope="scope">
        <span v-show="scope.row.iseditor" @click="goclick(scope.row,scope.column)" style="margin-left: 10px">{{ scope.row.standard}}</span>
        <el-input v-model="scope.row.standard" v-show="!scope.row.iseditor"></el-input>
      </template>
    </el-table-column>
    <el-table-column
      prop="post"
